const navbar = () => {
  return ` <nav
  class="w-full p-2 px-6 bg-gray-200 dark:bg-gray-700 flex shadow-xl items-center justify-end fixed top-0 z-10"
>

  <form class="flex items-center ml-96" id:"searchform">
...
<input
  ...
  <div>
          <img
            src="src/logo/text.png"
            alt=""
            class="w-44 hidden"
            id="logo-night"
          />
          <img
            src="src/logo/night.png"
            alt=""
            class="w-44 hidden"
            id="logo-light"
          />
